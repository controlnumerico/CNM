...
################################################################################
## Form generated from reading UI file 'int_keyboard.ui'
##
...
"}")
        ...
        self.esc.setMaximumSize(QSize(16777215, 60))
        ...
        self.left_arrow.setMaximumSize(QSize(16777215, 60))
        font2 = QFont()
        ...
        self.right_arrow.setMaximumSize(QSize(16777215, 60))
        ...
        sizePolicy1.setHeightForWidth(self.dlt.sizePolicy().hasHeightForWidth())
        self.dlt.setSizePolicy(sizePolicy1)
